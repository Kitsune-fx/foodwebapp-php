        ...
        <br><br><br><br><br><br>
            <span style="text-align:center;font-size:50px;">
               ...
               แก้ไขประเภท <br>
                    ...
                    <?php
                    $sql = "SELECT * FROM `food_catergory` WHERE `food_cat_id` = ".$_GET['id']."" ;
                    $ans = $conn->query($sql) ;
             ...
             <a href="cat.php" class="btn btn-default">กลับ</a>
                    ...
                    <form action="editcatdb.php" method="post" onsubmit="return userconfirm()">
                    
                        <input type="text" value="<?php echo $rows['food_cat_name'] ; ?>" class="form-control" name="cat_name">
                        <input type="hidden" value="<?php echo $rows['food_cat_id'] ; ?>" name="cat_id">
