        ...
        <br><br><br><br><br><br>
            ...
            <center>
                <div class="coantainer" style="font-size:23px;width:80%;">
                    ...
                    <a href="addfood.php" class="btn btn-success" style="float:left;">เพิ่มอาหาร</a>
                    <br><br>
             ...
             <div class="container" style="font-size:21px;">
                 <form action="foodadmin.php" method="post">
                  ...
                  if($search == "") {
                    $sql = "SELECT * FROM `food` INNER JOIN food_catergory ON food.food_catergory = food_catergory.food_cat_id INNER JOIN status ON status.food_status = food.food_status" ;
                      }
                 else{
                    ...
                    while($rows = $ans->fetch_assoc()){
                        ...
                        echo "<tr> <td> ".$i." </td> <td>".$rows['food_name']." <td> ".$rows['food_cat_name']." </td>  <td>".$rows['food_price']."</td> <td>".$rows['status_name']."</td> <td><a href='editfood.php?id=".$rows['food_id']."'> <span style='float:center;' class='btn btn-warning'>แก้ไข </span> </a></td> <td> <a href='delfood.php?id=".$rows['food_id']." ' onclick='return userconfirm()'> <span style='float:center;' class='btn btn-danger' >  ลบ </a> </span> </td> </tr>";
